  ...
  function OutputStatement(props) {
      ...
      return (
        <>
          <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
            The given URL is <span className="font-extrabold"> SAFE </span> ! ✅
    ...
    if (props.THREAT_LEVEL == "POTENTIAL") {
      return (
        <>
          <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
            The given URL is{" "}
            <span className="font-extrabold"> Potentially Risky </span> ! ⚠️ Use
            Incognito Mode & VPN for safety.
          </h1>
        </>
      );
    }
    ...
    return (
      <>
        <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
          The given URL is{" "}
          <span className="font-extrabold"> Highly Malicious </span> ! ❌ Please
          Don't Visit It.
        </h1>
      </>
    );
      ...
      {output["target_urls"].length > 0 ? (
        <div className="flex flex-row justify-center">
          <div className="text-center bg-gray-200 p-4 rounded mt-5 font-semibold">
            <span role="img" aria-label="police" className="text-2xl">
              👮‍♂️
            </span>{" "}
